"""
Django settings for knot_art project.
...
ALLOWED_HOSTS = ['knot-art.herokuapp.com', 'localhost']
...
# to display numbers with thousand separators - for prices, bag total etc.
...
# not setting STATIC_ROOT which would be needed for collectstatic, as
# it will interfere with AWS

# uploaded media files go here
MEDIA_URL = '/media/'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'knotart@example.com'
else:
